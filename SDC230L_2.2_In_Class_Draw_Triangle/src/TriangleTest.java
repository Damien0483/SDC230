...
public class TriangleTest {
    ...
    /* ============================================================================
            ...
            Return:       void
            Description:  Controls program execution. Prompts the user for an
                          initial triangle size, displays a menu of options,
                          processes user selections, and calls the appropriate
                          DrawTriangle methods to print patterns or update size.
    ============================================================================*/
