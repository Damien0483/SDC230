/*==================================================
  ...
  Assignment: Project  
  Description: A simple flooring calculator 
  that calculates the total area of a room in
   square feet based on rectangular sections.
====================================================*/
...
public class FloorCalculator {
    ...
    public static void main(String[] args) {
        ...
        // -----------------------------------------
        System.out.println("==========================================================");
        System.out.println("Welcome to Damien's Flooring Calculator Project Week 2!!!");
        System.out.println("==========================================================");
        System.out.println();
        ...
        System.out.println("hoping the floor won't reveal any surprise or bonus corners the architect dreamed up");
        ...
        System.out.println("- And a healthy sense of optimism, because every room is 10% bigger once you start paying");
        System.out.println();
        System.out.println("Armed with those tools, you're ready to measure like a pro.");
        System.out.println();
        ...
        while (true) {
            ...
            System.out.println("3. Multiply length x width");
